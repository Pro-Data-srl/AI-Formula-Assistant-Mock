...
- **askClarification**: Nur wenn die Nutzerabsicht unklar ist — stellt **eine** konkrete Rückfrage. Nach diesem Werkzeug endet die Fähigkeitsschicht; kein weiteres Werkzeug im selben Lauf nötig.
